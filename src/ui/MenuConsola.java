...
public class MenuConsola
{
    ...
    public int printOpcionesPreconfiguradoSistema()
    {
		...
		System.out.println("├────────────────────────────┼─────────────┼──────────────┤");
		System.out.println("│ " + VERDE + "[1] Windows (Dell XPS)     " + RESET + "│     " + VERDE + "20" + RESET + "      │      " + VERDE + "80" + RESET + "      │");
		System.out.println("│ " + VERDE + "[2] macOS (Macbook Pro M5) " + RESET + "│     " + VERDE + "50" + RESET + "      │      " + VERDE + "50" + RESET + "      │");
		System.out.println("│ " + VERDE + "[3] Linux (Thinkpad)       " + RESET + "│     " + VERDE + "75" + RESET + "      │      " + VERDE + "25" + RESET + "      │");
	...
	public int printOpcionesPreconfiguradoMalware() {
		...
		System.out.println("├──────────────────────────┼────────────┼─────────────────┤");
		System.out.println("│ " + ROJO + "[1] Zeus(Troyano)        " + RESET + "│     " + ROJO + "50" + RESET + "     │       " + ROJO + "50" + RESET + "        │");
		System.out.println("│ " + ROJO + "[2] Ryuk(Ransomware)     " + RESET + "│     " + ROJO + "20" + RESET + "     │       " + ROJO + "80" + RESET + "        │");
		System.out.println("│ " + ROJO + "[3] Emotet(Keylogger)    " + RESET + "│     " + ROJO + "80" + RESET + "     │       " + ROJO + "20" + RESET + "        │");
		System.out.println("└──────────────────────────┴────────────┴─────────────────┘");
        // @on on formatter
    ...
    public void printTransicionASistema()
    {
        ...
        System.out.println(
            "\n[!] Pasando automáticamente a la configuración de Defensa...");
    ...
    public void printTransicionAMalware()
    {
        System.out.print(AMARILLO);
        System.out.println(
            "\n[!] Pasando automáticamente a la configuración de Amenaza...");
        System.out.print(RESET);
    }
    ...
    {
        String texto = "";
        // Mientras el texto este vacio o solo tenga espacios, sigue preguntando
        while (texto.trim().isEmpty())
        {
            ...
            {
                System.out.print("[!] El nombre no puede estar vacio. Escribe algo: ");
            }
        }

        // 1. trim() quita los espacios de los bordes
        // 2. replaceAll cambia cualquier bloque de espacios internos por un solo guion
        // bajo
